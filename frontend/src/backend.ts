...
import type { ProductListing as _ProductListing, UserProfile as _UserProfile, UserRole as _UserRole } from "./declarations/backend.did.d.ts";
export class Backend implements backendInterface {
    ...
    async addProduct(arg0: ProductListing): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.addProduct(to_candid_ProductListing_n1(this._uploadFile, this._downloadFile, arg0));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async getProducts(arg0: Principal): Promise<Array<ProductListing>> {
        if (this.processError) {
            try {
    ...
    async updateProduct(arg0: bigint, arg1: ProductListing): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateProduct(arg0, to_candid_ProductListing_n1(this._uploadFile, this._downloadFile, arg1));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_ProductListing_n9(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _ProductListing): ProductListing {
...
function from_candid_record_n10(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        ...
        price: record_opt_to_undefined(from_candid_opt_n11(_uploadFile, _downloadFile, value.price))
    };
}
...
function from_candid_vec_n8(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<_ProductListing>): Array<ProductListing> {
    return value.map((x)=>from_candid_ProductListing_n9(_uploadFile, _downloadFile, x));
}
function to_candid_ProductListing_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: ProductListing): _ProductListing {
